...
interface EditJuryModalProps {
  ...
  const EditJuryModal: React.FC<EditJuryModalProps> = ({ isOpen, onClose }) => {
    ...
    return (
      ...
      >
        ...
        >
          <h2 className="text-xl text-start font-semibold mb-4">Edit Jury Info</h2>
